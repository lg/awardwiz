(async () => {
  ...
  const scraperModule: typeof import("../scrapers/alaska") = await import("./aeroplan")
  ...
  const results = await callMethod({ page, context: { origin: "SFO", destination: "YYZ", departureDate: "2022-06-04" } })
